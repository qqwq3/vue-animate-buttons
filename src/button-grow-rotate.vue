<template>
    <button type="button" @click="onClick" :style="styles" :class="['buts hvr-grow-rotate', customClass]">{{ !isSlot ? text : null }}<slot v-if="isSlot"></slot></button>
</template>

<script>
    export default {
        name: "button-grow-rotate",
